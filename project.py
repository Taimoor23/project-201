...
def calculate_interest():
    ...
    interest = round(i,2)
    show_result.destroy()
    message = Label(result_frame,text='Interest' +str(p)+ 'at rate of interest' +str(r)+ 'for' +str(t)+ 'years is' +str(interest), bg='lightcyan',font=('Calibri',12),width=55)
...
principle = Label(window,fg='black',text='Principle',bg='lightcyan',font=('Calibri',20))
principle.place(x=20,y=100)
principle_entry = Entry(window, text = '', bd= 2, width=22)
principle_entry.place(x=210,y=110)
rate = Label(window,fg='black',text='Rate of interest',bg='lightcyan',font=('Calibri',20))
rate.place(x=20,y=140)
rate_entry = Entry(window, text = '', bd= 2, width=22)
rate_entry.place(x=210,y=152)
time = Label(window,fg='black',text='Time',bg='lightcyan',font=('Calibri',20))
time.place(x=20,y=180)
time_entry = Entry(window,text='',bd=2,width=22)
time_entry.place(x=210,y=190)
calculate_button = Button(window,text='Calculate',fg='black',font=('Calibri',12),bg='cyan',bd=4,command=calculate_interest)
...
show_result = Label(result_frame,text=' ',bg='lightcyan',font= ('Calibri',12),width=55)
